class UserStocksController < ApplicationController
    def create
      ...
      stock_lastprice=Stock.new_lookup(params[:ticker]).last_price
      stock.update(last_price: stock_lastprice)
      if !stock
         ...
         flash[:notice]="Your stock #{stock.name} is added successfully"
